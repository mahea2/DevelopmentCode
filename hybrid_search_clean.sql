-- Clean Focused Hybrid Search - Following Exact Requirements
...
BEGIN
    ...
    BEGIN
        OPEN c_search(v_query_vector, v_search_term, v_customer_id, v_days_lookback, v_offset, v_top_n);
        
        LOOP
            FETCH c_search INTO rec;
